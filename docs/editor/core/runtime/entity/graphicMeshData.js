...
export class GraphicMeshData extends RuntimeDataBase {
    constructor(/** @type {Application} */ app) {
        ...
        this.texCoords = new BufferManager(this, "texCoords", ["f32","f32"], "verticesNum");
        ...
        this.texCoordOffsets = new BufferManager(this, "texCoordOffset", ["f32","f32","f32","f32"], "1");
    ...
    setGroup() {
        if (this.order.length) {
            ...
            GPU.writeBuffer(this.texCoordOffsets.buffer, GPU.createBitData(result.texCoordOffset.flat(), ["f32"]), 0);
            changeParameter(this, "textureAtls", result.texture)
            this.textureAtlsView = this.textureAtls.createView();
            this.renderGroup = GPU.createGroup(GPU.getGroupLayout("Vsr_Vsr_Vsr_Vsr_Ft"), [this.renderingVertices.buffer, this.texCoords.buffer, this.texCoordOffsets.buffer, this.renderingMetaDatas.buffer, this.textureAtlsView ? this.textureAtlsView : GPU.isNotTexture.createView()]); // 表示用
